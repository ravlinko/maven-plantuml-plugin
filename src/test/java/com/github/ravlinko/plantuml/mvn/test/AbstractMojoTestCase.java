...
public class AbstractMojoTestCase extends PlexusTestCase {
    ...
    static {
        ...
        InputStream is = org.apache.maven.plugin.testing.AbstractMojoTestCase.class.getResourceAsStream(path);
        try {
    ...
    protected void setUp()
        ...
        InterpolationFilterReader interpolationFilterReader =
                new InterpolationFilterReader(new BufferedReader(reader), container.getContext().getContextData().entrySet().stream()
