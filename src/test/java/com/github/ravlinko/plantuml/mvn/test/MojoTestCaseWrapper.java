package com.github.ravlinko.plantuml.mvn.test;
...
public class MojoTestCaseWrapper {

    protected final AbstractMojoTestCase testCase;

    public Mojo lookupTestMojo(String pomFilePath, String mvnGoal) throws Exception {
        File pom = new File(pomFilePath);
        assertNotNull(pom);
        assertTrue(pom.exists());
        this.testCase.setUp();
        return lookupMojo(mvnGoal, pom);
    }

    public MojoTestCaseWrapper()
    {
        this( new AbstractMojoTestCase() {} );
    }

    public MojoTestCaseWrapper(AbstractMojoTestCase testCase)
    {
